...
const ComingSoon = () => {
  ...
  const features = [
    { icon: Repeat, title: "AI-powered follow-ups", description: "Re-engage Cold Leads Automatically", delay: "0s" },
    { icon: FileText, title: "Smart intake forms", description: "Auto-fill Data, Validate Entries, and Routing Intelligently", delay: "0.1s" },
    { icon: Mail, title: "Drip Marketing Flows", description: "Time-Based Reminders, Promos, and Nurture Campaigns", delay: "0.2s" },
    { icon: Phone, title: "Voice AI support", description: "Automate Calls, Bookings, and Phone Support with Voice Bots", delay: "0.3s" },
    { icon: Link, title: "Deeper CRM Sync", description: "Connect to HubSpot, Notion, and Beyond", delay: "0.4s" }
  ];
